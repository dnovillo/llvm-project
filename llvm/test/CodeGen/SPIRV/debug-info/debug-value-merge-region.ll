...
;
; A single record does not reach the case: the backward scan in
; findAdjacentEmittedInstruction() only returns another debug record, rather
; than the merge, when a second one is present.
...
; CHECK: OpExtInst [[VOID]] [[EXT]] DebugValue [[CONDVAR]] [[CMP]] [[EXPR]]{{ *$}}
; CHECK: OpExtInst [[VOID]] [[EXT]] DebugDeclare [[SLOTVAR]] [[SLOT]] [[EXPR]]{{ *$}}
